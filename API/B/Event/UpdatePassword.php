...
final class UpdatePassword {
	 ...
	 */
	static function reset(ICD $cd, $backend = false) {
		self::p('forgot_password', $backend ? 'forced_reset' : 'pending', $cd, $backend);
	}
	 ...
	 * @param bool $backend [optional]
	 */
	static function p($rs, $st, ICD $cd = null, $backend = false) {_P::f(function() use($rs, $st, $cd) {
		B::p('update_password', [
			/**
